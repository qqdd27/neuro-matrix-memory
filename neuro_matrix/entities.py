...
RU_STOP = {
    ...
    # Interrogatives and their inflections.  These are question scaffolding, not
    # content: leaving them in makes every "какие/сколько/какой" query match any
    # text containing the stem "как", which floods recall on real Russian queries
    # while polluting the FTS candidate list (measured on a live database).
    "какие", "какой", "какая", "какое", "каких", "каким", "какими", "каком",
    "сколько", "чем", "чём", "кто", "кого", "кому", "почему", "зачем", "где",
    "куда", "откуда", "чей", "такой", "такая", "такие", "тоже", "также",
    "очень", "более", "менее", "самый", "самая", "нужен", "нужна", "нужны",
    "теперь", "тогда", "всегда", "никогда", "обычно", "часто", "редко",
    "вроде", "типа", "значит", "ведь", "давай", "давайте", "будто",
}
